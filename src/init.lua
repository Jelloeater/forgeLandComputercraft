...
local url_bb = 'https://bitbucket.org/dertroglodyt/computercraftprograms/raw/tip/src/prog/bitbucket.lua'
...
local url_json = 'https://bitbucket.org/dertroglodyt/computercraftprograms/raw/tip/src/api/json.lua'
...
os.loadAPI("/bb/api/serial")
local reboot = serial.varFromFile("reboot_cmd")
if (reboot ~= nil) then
  print("continuing last program: " .. reboot)
  shell.run(reboot)
end
